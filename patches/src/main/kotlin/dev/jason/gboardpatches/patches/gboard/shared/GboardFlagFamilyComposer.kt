...
internal enum class GboardFlagFamilyFeature(
    ...
    MULTIPLE_SMART_SUGGESTIONS(
        35,
        RuntimeCallId.MULTIPLE_SMART_SUGGESTIONS_RUNTIME_APPLY_FLAG_VALUE,
        GboardFlagFamilyArgumentShape.FLAG_NAME_AND_RESULT,
    ),
    KEY_SHAPE_SELECTION(
        40,
...
private val ALL_FLAG_FAMILY_RUNTIME_CALLS: Set<RuntimeCallId> =
    GboardFlagFamilyFeature.entries.mapTo(linkedSetOf()) { feature -> feature.runtimeCall }
